...
\begin{flalign}
    \begin{split}
        ...
        &\times \sum_{n=0}^{\infty}
{q^{\frac{-n}{2}} b^n c^n z^n a^{\frac{-n}{2}} \frac{\left(q a;q\right)_{2n} \left(q^{\frac{1}{2}}\frac{a^{\frac{3}{2}}}{b c};\scA ,\scB, \scC,d,e,f; q\right)_n}{\left(\sqrt{q}\frac{a^{\frac{3}{2}}}{b c};q\right)_{2n} \left(q, \sqrt{qa}, q \frac{a}{b},q \frac{a}{c},q \frac{a}{d},q \frac{a}{e}, q \frac{a}{f} ;q\right)_n}} \\
& \times \sum_{m=0}^{\infty} \dsA^m \frac{\dsB \dsC \dsD}{\dsE \dsF \dsG} \sum_{j=0}^{\infty}q^\dsH \frac{ \dsI^j \dsJ \dsK}{\dsL \dsM} \int_{-\pi}^{\pi} \frac{\dsN}{\dsO} \,{\mathrm d}\zeta
    \end{split}
\end{flalign}
