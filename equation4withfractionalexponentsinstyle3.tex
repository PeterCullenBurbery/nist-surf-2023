...
\begin{flalign}
\begin{split}
      \dsZ &=q^{\frac{1}{2}}\frac{a^{\frac{3}{2}}}{b c}\\
      &=\sqrt{q} \frac{a^{\frac{3}{2}}}{b c}  
\end{split}
\end{flalign}
...
\begin{split}
        ...
        &= \left(\sqrt{q}\frac{a^{\frac{3}{2}}}{b c};q\right)_{2n}
\end{split}
\end{flalign}
...
\begin{split}
        ...
        & =\left(q, \sqrt{qa}, q \frac{a}{b},q \frac{a}{c},q \frac{a}{d},q \frac{a}{e}, q \frac{a}{f} ;q\right)_n
\end{split}
\end{flalign}
...
\subsubsection{\dsO}
\begin{flalign}
    \dsO=\left(\goW,\goX,\goY,\goZ,\pm \Gamma,\Delta,;q\right)_{\infty}
\end{flalign}
...
\begin{flalign}
\begin{split}
    \goZ & =q^{\frac{2j+2m+2n-3}{4}}\frac{g \sqrt{b c e f z}}{a^{\frac{3}{4}} \rho}
\end{split}    
\end{flalign}
\paragraph{\(\Gamma\)}
\begin{flalign}
\Gamma = -q^{\frac{2j+2m+2n-1}{4}} \frac{g \sqrt{b cd e f z}}{a^{\frac{3}{4}} \rho}
\end{flalign}
...
\begin{flalign}
    \begin{split}
        \Delta=q^{\frac{2j+2m+2n+5}{4}} \frac{a^{\frac{5}{4}} g}{\rho}\sqrt{\frac{z}{b c d e f}}
    \end{split}
\end{flalign}

\section{combining parts of equation 4}
\begin{flalign}
    \begin{split}
        \Whyp{8}{7}{a}{b,c,d,e,f}{q,z}%\dsW%
        &=\frac{\left( q, q^{-4} \left(\frac{b c d e f z}{a^2}\right)^2 ;q\right)_{\infty}}{2 \pi \left( f,\frac{q}{f} ,q^{-3} \left(\frac{b c d e f z}{a^2}\right)^2;q \right)_{\infty}} \\
        &\times \sum_{n=0}^{\infty}
q^{\frac{-n}{2}} b^n c^n z^n a^{\frac{-n}{2}} \\
& \times \frac{\left(q a;q\right)_{2n} }{ \left(q, \sqrt{qa}, q \frac{a}{b},q \frac{a}{c},q \frac{a}{d},q \frac{a}{e}, q \frac{a}{f} ;q\right)_n} \\
&\times \frac{\left(q^{\frac{1}{2}}\frac{a^{\frac{3}{2}}}{b c};\scA ,\scB, \scC,d,e,f; q\right)_n}{\left(\sqrt{q}\frac{a^{\frac{3}{2}}}{b c};q\right)_{2n}}\\
& \times \sum_{m=0}^{\infty} \left(\frac{b c d z}{q a}\right)^m \frac{\dsB \dsC \dsD}{\dsE \dsF \dsG} \\
&  \times \sum_{j=0}^{\infty}q^\dsH \frac{ \dsI^j \dsJ \dsK}{\dsL \dsM} \int_{-\pi}^{\pi} \frac{\dsN}{\dsO} \,{\mathrm d}\zeta
    \end{split}
\end{flalign}
