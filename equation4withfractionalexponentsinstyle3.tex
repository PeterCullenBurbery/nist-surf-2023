...
\newcommand{\dsH}{\ensuremath{\dmathbb{H}}}
...
\begin{flalign}
\W=\frac{\U}{2\pi\V} \sum_{n=0}^{\infty}{\PP^n \frac{\Q \R}{\SSS \T}} \sum_{m=0}^{\infty} \dAA^m \frac{\dB \dC \dD}{\dE \dF \G} \sum_{j=0}^{\infty} q^{\HH} \frac{ \I^j \J \K}{\LL \M} \int_{-\pi}^{\pi} \frac{\N}{\OO} \,{\mathrm d}\zeta
\end{flalign}
...
\subsection{second sum with the index variable m defined in terms of \dAA, \dB, \dC, \dD, \dE, \dF and \G}

\begin{flalign}
    \dAA=\left(\frac{b c d z}{q a}\right)
\end{flalign}
